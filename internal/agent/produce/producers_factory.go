...
func AbstractProducerFactory(producerType string, interval time.Duration, serverAddress string, repo entities.MetricsRepository, logger *zap.SugaredLogger) (ProducerAbstractFactory, error) {
	switch producerType {
