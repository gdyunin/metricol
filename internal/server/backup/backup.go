...
// Backupper defines the methods required for performing backup-related operations.
// Any type that implements these methods can be considered a "Backupper".
type Backupper interface {
	// StartBackup begins the backup process. It may trigger operations to store data
